...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/falling-thunder-8b51
```

A live public deployment of this template is available at [https://falling-thunder-8b51.templates.workers.dev](https://falling-thunder-8b51.templates.workers.dev)
